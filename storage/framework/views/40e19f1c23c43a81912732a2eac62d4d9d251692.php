        ...
        <section class="grid grid-cols-1 lg:grid-cols-2 xl:grid-cols-3 2xl:grid-cols-4 3xl:grid-cols-5 4xl:grid-cols-6 gap-4">
            ...
            <div class="relative md:h-[180px] group cursor-pointer" tabindex="0">
                ...
                <div
                    ...
                    <p><strong>Nombre:</strong> <?php echo e($reserva->nombre); ?></p>
            ...
            <div class="col-span-full">
                <p class="flex gap-[6px]">No tienes ninguna reserva pendiente, ve a <a href="<?php echo e(url('buscar-sala')); ?>" class="hover:text-[#990000] font-semibold flex hover:scale-105">nuevas reservas <svg xmlns="http://www.w3.org/2000/svg" width="30" height="30" class="-translate-y-[8px]" viewBox="0 0 20 20">
